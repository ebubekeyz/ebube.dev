    ...
    <Wrapper>
      <section className="footer">
        ...
        <article>
          <h1>Newsletter</h1>
          <p>
            Subscribe to my newsletter for news, tips, and special offers
        ...
        <article className="footer-second">
          ...
          <p>
            At Ebube.dev, I specialize in building modern, scalable web
            applications with attention to detail, clean code, and reliable
            performance.
          </p>
